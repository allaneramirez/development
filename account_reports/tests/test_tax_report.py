...
class TestTaxReport(TestAccountReportsCommon, HttpCase):
    ...
    def test_tax_report_closing_entry_draft_with_new_entries(self):
        ...
        self.init_invoice('out_invoice', partner=self.partner_a, invoice_date='2023-03-22', post=True, amounts=[200], taxes=regular_tax)
        ...
        self.init_invoice('out_invoice', partner=self.partner_a, invoice_date='2023-03-22', post=True, amounts=[1000], taxes=regular_tax)
